...
class ClaimBotHandler extends GroupHandler
{
    public function __construct(
        ...
        $baseClaimRequestHandler = new CloudWatch(
            $awsClient,
            $groupName,
            'gift_aid_requests',
            $retentionDays,
        ...
        $baseClaimResponseHandler = new CloudWatch(
            $awsClient,
            $groupName,
            'gift_aid_responses',
            $retentionDays,
        ...
        $basePollRequestHandler = new CloudWatch(
            $awsClient,
            $groupName,
            'gift_aid_poll_requests',
            $retentionDays,
            $batchSize,
        );
        $basePollResponseHandler = new CloudWatch(
            $awsClient,
            $groupName,
            'gift_aid_poll_responses',
            $retentionDays,
            $batchSize,
        );

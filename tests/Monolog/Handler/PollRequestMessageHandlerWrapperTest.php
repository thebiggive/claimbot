...
use ClaimBot\Monolog\Handler\PollRequestMessageHandlerWrapper;
use ClaimBot\Tests\TestCase;
use Monolog\Handler\NullHandler;
use Monolog\Logger;

class PollRequestMessageHandlerWrapperTest extends TestCase
{
    private PollRequestMessageHandlerWrapper $handler;

    public function setUp(): void
    {
        $this->handler = new PollRequestMessageHandlerWrapper(new NullHandler());
    }
    ...
    public function testMatchingContextMessageIsHandled(): void
    {
        $log = [
            ...
            'level' => Logger::INFO,
            'context' => ['gift_aid_message' => 'poll_request'],
            'extra' => [],
        ];
